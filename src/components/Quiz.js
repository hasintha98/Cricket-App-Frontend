...
function Quiz({ changeStatus, run }) {
    ...
    const renderer = ({ hours, minutes, seconds, completed }) => {
        if (completed) {
            ...
            return <h1 style={{ color: "red", fontSize: '1em', margin: "10px", fontWeight: "bold" }}>Time: {minutes}:{seconds}</h1>;
        } else {
            // Render a countdown
            if (minutes == 0 && seconds < 4) {
                return <h1 style={{ color: "red", fontSize: '1em', margin: "10px", fontWeight: "bold" }}>Time: {minutes}:{seconds}</h1>;
            } else {
                return <h1 style={{ color: "#fff", fontSize: '1em', margin: "10px", fontWeight: "bold" }}>Time: {minutes}:{seconds}</h1>;
            }
        ...
        <>
            ...
            />
                ...
                >
                    ...
                    <p style={{ color: "#fff", fontWeight: 'bold', fontSize: "1.2em", margin: 5 }}>99 / 2</p>
                    <hr style={{ borderWidth: "2px", borderColor: "#fff", opacity: 100, padding: 0, margin: 0 }} />
                    <p style={{ color: "#fff", fontWeight: 'bold', fontSize: "0.5em", margin: 5 }}> Balls 2/10</p>
